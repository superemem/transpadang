...
<div class="screen">
	<header class="hd">
		...
		<div class="ttl">Cari {planner.editing === 'from' ? 'asal' : 'tujuan'}</div>
	</header>
	<div class="bd">
		<div class="wip">
			<div class="wip-title">🔍 Layar Search — menyusul</div>
			<div class="wip-sub">Field aktif: <b>{planner.editing}</b> · autocomplete dari PLACES</div>
		</div>
	</div>
</div>
